...
const ProjectsPage = () => {
  ...
  const redirigir = () => navigate("/project/new-project");
        ...
        <Row>
          <Col className="contenedor-ui-proyectos">
            <div className="titulo w-100">
              <h1 className="texto-titulo">ProjectsPage</h1>
              ...
              {proyectos?.length ? (
                proyectos.map((item) => (
                  <div
                    ...
                    className="contenedor-tarjeta-proyecto"
                  >
